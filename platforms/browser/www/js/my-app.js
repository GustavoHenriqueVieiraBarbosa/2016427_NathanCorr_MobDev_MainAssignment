...
function save() {
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, fileWriteSystemCallback, onError);
 }


function fileWriteSystemCallback(fs) {
    // NAME OF FILE TO CREATE
    var fileToCreate = "location_data_file_test1.txt";
    // OPEN / CREATE THE FILE
    fs.root.getFile(fileToCreate, fileSystemOptionals, getWriteFileCallback, onError);
}


function getWriteFileCallback(fileEntry) {
...
function readLocationFile() {
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, fileReadSystemCallback, onError);
}

function fileReadSystemCallback(fs) {
    // NAME OF FILE TO CREATE
    var fileToCreate = "location_data_file_test1.txt";
    // OPEN / CREATE THE FILE
    fs.root.getFile(fileToCreate, fileSystemOptionals, getReadFileCallback, onError);
}

var fileSystemOptionals = { create: true, exclusive: false };

function getReadFileCallback(fileEntry) {
    readFile(fileEntry);
}
...
// FUNCTION TO CONVERT TEXT FILE TO OBJECT
